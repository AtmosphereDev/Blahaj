...
public class Common {
	...
	public static final ResourceLocation BROWN_BEAR_ID;
...
//		LootTableEvents.MODIFY.register((resourceManager, lootManager, id, tableBuilder, source) -> {
	...
	static {
		BLAHAJ_ID = ResourceLocation.fromNamespaceAndPath(NAMESPACE, "blue_shark");
		KLAPPAR_HAJ_ID = ResourceLocation.fromNamespaceAndPath(NAMESPACE, "gray_shark");
		BLAVINGAD_ID = ResourceLocation.fromNamespaceAndPath(NAMESPACE, "blue_whale");
		BREAD_ID = ResourceLocation.fromNamespaceAndPath(NAMESPACE, "bread");
		BROWN_BEAR_ID = ResourceLocation.fromNamespaceAndPath(NAMESPACE, "brown_bear");
	}
	...
	public static Item register(String name, String subtitle) {
		...
		Item tCuddlyItem = new CuddlyItem(new Item.Properties().stacksTo(1), subtitle);
